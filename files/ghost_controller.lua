...
origs[1] = origs[1] + mnee.mnin( "axis", {"kappa","movement_h"}, {dirty=true})*speed
origs[2] = origs[2] + mnee.mnin( "axis", {"kappa","movement_v"}, {dirty=true})*speed
...
local is_done = mnee.mnin( "bind", {"kappa","melee"}, {pressed=true,dirty=true})
    or mnee.mnin( "bind", {"kappa","suicide"}, {pressed=true,dirty=true})
    or mnee.mnin( "bind", {"kappa","spawn"}, {pressed=true,dirty=true})
